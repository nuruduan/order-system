...
$sql = $sql = "SELECT s.staff_id, u.user_id, u.username, u.fullName, u.email 
                    ...
                    <nav class="header__menu mobile-menu">
                        <ul>
							...
							<?php if ($level == 1): ?>
								...
								<li class="active"><a href="/dessert-order/ADMIN/staffs_list.php">Staff</a></li>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
					...
					<button class="btn-edit" onclick="location.href='edit_staff.php?id=<?= $row['user_id'] ?>'">Edit</button>
					<button class="btn-delete" onclick="if(confirm('Are you sure to delete?')) location.href='delete_staff.php?id=<?= $row['user_id'] ?>'">Delete</button>
				</td>
            </tr>
            <?php endwhile; ?>
        </table>
